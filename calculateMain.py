...
from filtroButter import filterButterBP
...
from IACC import IACC as IACCf
from Tt import TtEDTt
...
def calculateMono(ir, fs, analysis, smoothing, noiseComp, medianwindow, *IACC):
    ...
    # irFilt2 = filtromediamovil(irFilt2,500)               # Uncomment to use moving average filter
